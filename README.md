...
- **Task watcher — desktop notifications for new tracker items** *(v0.8.0)*.
  ...
  the side panel closed. Plain HTTP polling: no agent, zero Claude tokens. (v0.8.1: toast delivery is diagnosable in the SW console — Windows DND is the usual suppressor. v0.8.2: onlyNewerIds kills phantom notifications from pagination window-sliding.)
